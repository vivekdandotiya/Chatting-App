        ...
        <div className="relative z-10 w-full max-w-md">
          <div className="relative p-6 sm:p-8 md:p-10 rounded-xl bg-[#121212] border border-[#27272a] shadow-2xl">
            ...
            <p className="text-center text-gray-500 text-sm">
              ...
              <button onClick={() => navigate("/signup")} className="text-white hover:underline font-semibold transition">
                Sign up now
              </button>
            </p>
          </div>
    ...
    <div className="min-h-full w-full bg-black flex flex-col justify-center px-6 sm:px-8 py-8 relative overflow-hidden text-white font-sans">
      <div className="w-full max-w-sm mx-auto flex flex-col">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="flex items-center justify-between pt-1 pb-2">
            <label className="flex items-center gap-2 cursor-pointer group">
              <input
                type="checkbox"
                className="w-3.5 h-3.5 rounded border border-[#333] bg-black accent-white cursor-pointer grayscale"
                disabled={loading}
              />
              <span className="text-[12px] text-[#8e8e93] group-hover:text-white transition">
                Remember me
              </span>
            </label>
            <a
              href="#"
              className="text-[12px] text-[#8e8e93] hover:text-white transition font-medium"
            >
              Forgot password?
            </a>
          </div>
        ...
        <div className="flex gap-3 mb-8">
          <button className="flex-1 flex items-center justify-center gap-2 py-3 bg-[#141414] border border-[#2a2a2a] rounded-xl hover:bg-[#1a1a1a] transition text-[#8e8e93] hover:text-white text-[13px] font-medium">
