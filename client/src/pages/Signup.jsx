      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="relative p-6 sm:p-8 md:p-10 rounded-3xl bg-gradient-to-br from-slate-900/80 to-slate-950/80 border border-slate-700/50 backdrop-blur-xl shadow-2xl">
          ...
          <div className="mb-8 sm:mb-10">
            <div className="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-purple-600 to-pink-600 rounded-2xl flex items-center justify-center mb-4 shadow-lg shadow-purple-500/30">
              <svg
          ...
          <form onSubmit={handleSignup} className="space-y-4 sm:space-y-5">
            ...
            <div className="group relative">
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl blur opacity-0 group-focus-within:opacity-20 transition duration-300"></div>
              <input
                type="text"
                ...
                disabled={loading}
                className="relative w-full px-4 sm:px-5 py-3 sm:py-4 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:bg-slate-800 focus:border-purple-500/50 transition-all duration-300 text-sm sm:text-base disabled:opacity-50 disabled:cursor-not-allowed"
              />
            </div>
            ...
            {/* TERMS CHECKBOX */}
            <label className="flex items-start gap-3 cursor-pointer group p-3 -mx-3 rounded-lg hover:bg-slate-800/30 transition">
              <input
                type="checkbox"
                checked={agreeTerms}
                onChange={(e) => setAgreeTerms(e.target.checked)}
                disabled={loading}
                className="w-4 h-4 mt-1 rounded border border-slate-600 bg-slate-800/50 accent-purple-600 cursor-pointer"
              />
            ...
            <button
              ...
              className="w-full py-3 sm:py-4 mt-6 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-bold rounded-xl hover:shadow-lg hover:shadow-purple-500/50 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 text-sm sm:text-base flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-6 sm:mb-8">
            <button
              type="button"
              className="flex items-center justify-center gap-2 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl hover:bg-slate-800 transition text-slate-300 hover:text-white text-sm font-medium"
            >
