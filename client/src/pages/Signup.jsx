      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="relative p-6 sm:p-8 md:p-10 rounded-xl bg-[#121212] border border-[#27272a] shadow-2xl">
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-6 sm:mb-8">
            <button
              type="button"
              className="flex items-center justify-center gap-2 py-3 bg-[#18181b] border border-[#27272a] rounded-lg hover:bg-[#27272a] transition text-gray-300 hover:text-white text-sm font-medium"
            >
